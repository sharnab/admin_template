						...
						<div class="login-signin">
							...
							<form class="form" action="{{url('login')}}" method="post">
								...
								<div class="form-group">
									<input class="form-control h-auto bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" placeholder="Username" name="username" autocomplete="off" />
								...
								<div class="form-group">
									<input class="form-control h-auto bg-white-o-5 rounded-pill border-0 py-4 px-8" type="password" placeholder="Password" name="password" />
									@if ($errors->has('username'))
										<span class="help-block has-error red">
